...
var DynamicForm = (function (_super) {
    ...
    function DynamicForm() {
        ...
        _this.generateRenderEditItem = function (formDescriptions, options) {
            if (options === void 0) { options = { formItemLayout: exports.horizontalFormItemLayout }; }
            ...
            return function (key, ReactNode, options) {
                ...
                var label = config.label, rules = config.rules;
                return (react_1.default.createElement(antd_1.Form.Item, __assign({}, formItemLayout, lodash_1.get(options, 'customFormItemLayout'), { style: __assign({}, lodash_1.get(options, 'styles')), key: key, label: label, name: key, rules: rules }), ReactNode));
            };
        };
        _this.generateRenderViewItem = function () { return function () { }; };
        return _this;
    }
