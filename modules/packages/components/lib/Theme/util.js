...
var generateStyleHtml = function (colorObj) {
    var activeColor = colorObj.activeColor, primaryColor = colorObj.primaryColor, hoverColor = colorObj.hoverColor, shadowColor = colorObj.shadowColor, lightColor = colorObj.lightColor, darkColor = colorObj.darkColor;
    if (!IEVersion()) {
