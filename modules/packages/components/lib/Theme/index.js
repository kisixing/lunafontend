...
var A = function(props, ref) {
  ...
  var _a = props.primaryColor,
    primaryColor = _a === void 0 ? '#1890ff' : _a,
    _b = props.storageName,
    storageName = _b === void 0 ? 'custom-antd-primary-color' : _b,
    _c = props.style,
    style = _c === void 0 ? {} : _c,
    _d = props.placement,
    placement = _d === void 0 ? null : _d,
    _e = props.onChange,
    onChange = _e === void 0 ? null : _e,
    _f = props.mask,
    mask = _f === void 0 ? true : _f;
  var _g = react_1.useState(tinycolor2_1.default(primaryColor).toRgb()),
    color = _g[0],
    setColor = _g[1];
  var _h = react_1.useState(false),
    displayColorPicker = _h[0],
    setDisplayColorPicker = _h[1];
  ...
  var styles = {
    ...
    popover: __assign(
      ...
      util_1.placementSketchPicker(placement)
    ),
    cover: {
      position: 'fixed',
      top: '0px',
  ...
  var P = function() {
    return react_1.default.createElement(react_color_1.GithubPicker, {
  ...
  return react_1.default.createElement(
    'div',
    {
      id: 'change_antd_theme_button',
      style: __assign(__assign({}, styles.swatch), style),
      onClick: handleClick,
    },
    ...
    displayColorPicker
      ? react_1.default.createElement(
          ...
          mask &&
            react_1.default.createElement('div', { style: styles.cover, onClick: handleClose }),
