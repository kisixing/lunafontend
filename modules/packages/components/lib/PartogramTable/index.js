...
function EditableCell(props) {
  var value = props.value,
    ...
    o = __rest(props, ['value', 'onChange']);
  return react_1.default.createElement(antd_1.Table, {
    size: 'small',
    rowKey: 'id',
    pagination: false,
    columns: Columns_1.default(__assign({ onChange: onChange, value: value }, o)),
    dataSource: value,
  });
}
exports.default = function(_a) {
  ...
  function getData() {
    request_1.default
      .get(url + ('?gynecologicalExamId.specified=true&pregnancyId.equals=' + id), {
        loading: '请求中',
      })
      .then(function(res) {
        setData(
          res.map(function(_) {
            return __assign(__assign({}, _.gynecologicalExam), {
              visitTime: _.visitTime,
              outerId: _.id,
  ...
  return react_1.default.createElement(
    'div',
    { style: style },
    react_1.default.createElement(EditableCell, {
      value: data,
