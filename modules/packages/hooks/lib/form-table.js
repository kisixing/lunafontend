...
exports.useFormTable = function(config) {
  ...
  var search = formTableConfig.search,
    _a = formTableConfig.autoFirstSearch,
    autoFirstSearch = _a === void 0 ? true : _a,
    _b = formTableConfig.defaultPageSize,
    defaultPageSize = _b === void 0 ? 10 : _b,
    _c = formTableConfig.defaultCurrent,
    defaultCurrent = _c === void 0 ? 1 : _c,
    _d = formTableConfig.defaultFormValues,
    defaultFormValues = _d === void 0 ? {} : _d,
  ...
  var _f = search_result_1.useSearchResult({
    ...
    loading = _f.loading,
    _g = _f.requestData,
    requestData = _g === void 0 ? { pageSize: defaultPageSize, current: defaultCurrent } : _g,
    setRequestData = _f.setRequestData,
    _h = _f.responseData,
    responseData = _h === void 0 ? {} : _h,
    defaultRequestDataLoading = _f.defaultRequestDataLoading,
    searchFunc = _f.search;
  var onFinish = function(values) {
    searchFunc(__assign({ current: 1, pageSize: requestData.pageSize }, values));
  };
  var onChange = function(pagination, filters, sorter) {
    searchFunc(
      __assign(__assign({}, requestData), {
