...
exports.useFormTable = function (config) {
    ...
    }), loading = _f.loading, _g = _f.requestData, requestData = _g === void 0 ? { pageSize: defaultPageSize, current: defaultCurrent } : _g, setRequestData = _f.setRequestData, _h = _f.responseData, responseData = _h === void 0 ? {} : _h, defaultRequestDataLoading = _f.defaultRequestDataLoading, searchFunc = _f.search;
