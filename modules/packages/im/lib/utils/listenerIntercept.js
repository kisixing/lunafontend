...
function listenerIntercept(conn) {
  ...
  conn.listen = function name(cbs) {
    var onTextMessage = cbs.onTextMessage,
      onAudioMessage = cbs.onAudioMessage,
      onVideoMessage = cbs.onVideoMessage,
      onFileMessage = cbs.onFileMessage,
      onPictureMessage = cbs.onPictureMessage,
      others = __rest(cbs, [
        'onTextMessage',
        'onAudioMessage',
        'onVideoMessage',
    ...
    oldListen(
      __assign(__assign({}, others), {
        onTextMessage: function(msg) {
          console.log('raw txt msg', msg);
          var _msg = msgParse_1.parse(
            __assign(__assign({}, msg), { bodyType: msg_1.EMsgBodyType.txt }),
            user
          );
        ...
        onAudioMessage: function(msg) {
          var _msg = msgParse_1.parse(
            __assign(__assign({}, msg), { bodyType: msg_1.EMsgBodyType.audio }),
            user
          );
          this._event.emit(CHAT_MSG, _msg);
        ...
        onVideoMessage: function(msg) {
          var _msg = msgParse_1.parse(
            __assign(__assign({}, msg), { bodyType: msg_1.EMsgBodyType.video }),
            user
          );
          this._event.emit(CHAT_MSG, _msg);
        ...
        onFileMessage: function(msg) {
          var _msg = msgParse_1.parse(
            __assign(__assign({}, msg), { bodyType: msg_1.EMsgBodyType.file }),
            user
          );
          this._event.emit(CHAT_MSG, _msg);
        ...
        onPictureMessage: function(msg) {
          var _msg = msgParse_1.parse(
            __assign(__assign({}, msg), { bodyType: msg_1.EMsgBodyType.img }),
            user
          );
          this._event.emit(CHAT_MSG, _msg);
