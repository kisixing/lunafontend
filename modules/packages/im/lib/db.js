...
var AppDB = (function () {
    ...
    AppDB.prototype.init = function (username, pageLimit) {
        var _a;
    ...
    AppDB.prototype.exec = function (cb1, cb2) {
    ...
    AppDB.prototype.getUnreadList = function () {
    ...
    AppDB.prototype.fetchMessage = function (id, chatType, offset, limit) {
    ...
    AppDB.prototype.readMessage = function (chatType, id) {
        var $_TABLE = this.$_TABLE;
    ...
    AppDB.prototype.updateMessageStatus = function (id, status) {
        var $_TABLE = this.$_TABLE;
        return this.exec(function (resolve) {
            $_TABLE.where('id')
                .equals(id)
    ...
    AppDB.prototype.deleteMessage = function (id) {
    ...
    AppDB.prototype.updateMessageMid = function (mid, id) {
        var _this = this;
        setTimeout(function () {
    ...
    AppDB.prototype.addMessage = function (message, isUnread) {
    ...
    AppDB.prototype.clearMessage = function (chatType, id) {
        var $_TABLE = this.$_TABLE;
        return this.exec(function (resolve) {
            $_TABLE.where('type')
                .equals(chatType)
