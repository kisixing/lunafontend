...
var Request = (function () {
    function Request() {
        ...
        this.init = function (configs) {
            ...
            _this._request = umi_request_1.extend(__assign({ prefix: prefix.startsWith('/') ? prefix : (prefix.includes('://') ? prefix : "http://" + prefix), timeout: 10000, credentials: 'include', headers: {
