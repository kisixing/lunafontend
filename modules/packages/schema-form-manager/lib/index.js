...
function connectAdvanced(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.cache, cache = _c === void 0 ? false : _c, _d = _b.getStorageName, getStorageName = _d === void 0 ? function () {
        return String(name) + "_storage";
    } : _d, _e = _b.handleErr, handleErr = _e === void 0 ? function (arr) {
        return arr;
    } : _e, _f = _b.name, name = _f === void 0 ? $name : _f, _g = _b.getDisplayName, getDisplayName = _g === void 0 ? function (name) { return "ConnectAdvanced(" + name + ")"; } : _g, _h = _b.onSubmit, onSubmit = _h === void 0 ? function (formData, status) {
    ...
    } : _h, _j = _b.mergeFormValues, mergeFormValues = _j === void 0 ? function (arr) {
        return arr.reduce(function (result, current) {
            return __spreadArrays(result, [current.getFormState().values]);
        }, []);
    } : _j, _k = _b.forwardRef, forwardRef = _k === void 0 ? false : _k;
    ...
    return function wrapWithConnect(WrappedComponent) {
        ...
        function ConnectFunction(props) {
            var _props = __assign(__assign({}, props), { saveActions: saveActions, submit: submit });
            top.onbeforeunload = function (e) {
                return false;
                if (all.some(function (_) { return _.getFormState().dirty; })) {
                    return false;
                }
            };
