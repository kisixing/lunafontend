...
var array_1 = require("@uform/antd/esm/fields/array");
...
react_2.registerFormField('table', styled_components_1.default((function (_super) {
    ...
    class_1.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: className + " " + cls, style: style, onClick: this.onClearErrorHandler() },
            react_1.default.createElement("div", null,
                react_1.default.createElement(Table, { dataSource: value },
                    ...
                    react_1.default.createElement(Column, { key: 'operations', title: locale.operations, dataIndex: 'operations', width: operationsWidth, cell: function (item, index) {
                            return (react_1.default.createElement("div", { className: 'array-item-operator' },
...
var Table = styled_components_1.default((function (_super) {
    ...
    Table.prototype.renderTable = function (columns, dataSource) {
        var _this = this;
        return (react_1.default.createElement("div", { className: 'ant-table-body' },
            react_1.default.createElement("table", null,
                react_1.default.createElement("thead", null,
                    react_1.default.createElement("tr", null, columns.map(function (col, index) {
                        return (react_1.default.createElement("th", { key: index, className: 'ant-table-header-node', style: { minWidth: col.width } },
                            react_1.default.createElement("div", { className: 'ant-table-cell-wrapper' }, col.title)));
                    }))),
    ...
    Table.prototype.renderPlacehodler = function (dataSource, columns) {
        if (dataSource.length === 0) {
            return (react_1.default.createElement("tr", { className: 'ant-table-row' },
                react_1.default.createElement("td", { className: 'ant-table-cell', colSpan: columns.length },
                    react_1.default.createElement("div", { className: 'ant-table-empty', style: { padding: 10 } },
                        react_1.default.createElement("img", { src: '//img.alicdn.com/tfs/TB1cVncKAzoK1RjSZFlXXai4VXa-184-152.svg', style: { height: 60 } })))));
        }
    };
    ...
    Table.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: this.props.className },
            react_1.default.createElement("div", { className: 'ant-table zebra' },
                react_1.default.createElement("div", { className: 'ant-table-inner' }, this.renderTable(columns, dataSource)))));
    };
    return Table;
