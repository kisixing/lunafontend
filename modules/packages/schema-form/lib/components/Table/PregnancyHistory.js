...
var MyCheckbox = react_1.default.forwardRef(function (props, ref) {
    return react_1.default.createElement(antd_1.Checkbox, __assign({ checked: props.value }, props, { ref: ref }));
});
...
function EditableTable(props) {
    var _a = props.value, data = _a === void 0 ? [] : _a;
    var flag = false;
