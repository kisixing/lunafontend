...
import { ArrayField } from '@uform/antd/esm/fields/array';
  ...
  styled(
    class extends ArrayField {
      ...
      public render() {
        ...
        return (
          <div className={`${className} ${cls}`} style={style} onClick={this.onClearErrorHandler()}>
            <div>
...
const Table = styled(
  class Table extends Component<ITableProps> {
    ...
    public getColumns(children) {
      ...
      React.Children.forEach<React.ReactElement<IColumnProps, typeof Column>>(children, child => {
