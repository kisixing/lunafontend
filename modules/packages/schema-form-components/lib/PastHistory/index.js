...
var C = function(_a) {
  ...
  return react_2.default.createElement(
    ...
    react_2.default.createElement(
      ...
      { value: value, style: { width: '100%' }, onChange: onChange },
      react_2.default.createElement(
        antd_1.Row,
        null,
        datasource.map(function(d, index) {
          return react_2.default.createElement(
            antd_1.Col,
            { span: 8, key: index + Math.random().toString() },
            react_2.default.createElement(
              antd_1.Row,
              { gutter: 5, style: { marginBottom: '4px', lineHeight: '32px' } },
              react_2.default.createElement(
                antd_1.Col,
                { span: 10 },
...
react_1.registerFormField('DiseaseHistory', react_1.connect()(C));
