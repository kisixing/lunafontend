...
<<<<<<< HEAD
    var onSelect = props.onSelect, data = props.data, bedname = props.bedname, onClose = props.onClose, onDoubleClick = props.onDoubleClick, loading = props.loading, onSuitRead = props.onSuitRead, _a = props.themeColor, themeColor = _a === void 0 ? 'rgb(74, 20, 140)' : _a, unitId = props.unitId, isFullscreen = props.isFullscreen, headColor = props.headColor, fontColor = props.fontColor, backgroundColor = props.backgroundColor;
=======
...
<<<<<<< HEAD
        react_1.default.createElement(antd_1.Card, { size: "small", title: react_1.default.createElement(RenderTilte, null), style: { height: '100%' }, extra: react_1.default.createElement(Extra_1.default, { fontColor: fontColor, bedname: bedname, onClose: onClose, status: status, suit: suit, unitId: unitId }), headStyle: { background: headColor, color: fontColor }, bodyStyle: { padding: 0, height: 'calc(100% - 38px)' } },
            ...
            react_1.default.createElement(Bar_1.default, { backgroundColor: backgroundColor, mutableSuit: ref, onSelect: onSelect, unitId: unitId }, props.children))));
=======
