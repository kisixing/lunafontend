...
exports.Ctg_Analyse = function (_a) {
    ...
    return (react_1.default.createElement(Wrapper, { ref: wrap },
        react_1.default.createElement(antd_1.Row, { style: { height: '100%', alignContent: 'flex-start' } },
            react_1.default.createElement(antd_1.Col, { style: { height: "calc(100% - 460px - 6px)", marginBottom: 6, boxShadow: '#ddd 0px 0px 2px 2px', width: '100%', display: 'flex' } },
                react_1.default.createElement(lmg_1.Ctg, { style: { minHeight: 200, overflow: 'hidden', flex: 1 }, suitType: 1, ref: ref, loading: loading, data: ctgData }),
                react_1.default.createElement("div", { style: { width: 428, marginLeft: 6, borderLeft: '1px solid #ddd' } },
                    react_1.default.createElement("div", { style: {} }, "123"))),
            react_1.default.createElement(antd_1.Col, { span: 17, style: { height: 460 } },
