    ...
    return (react_1.default.createElement("div", { style: { height: '100%', background: '#fff' }, className: "bordered" },
        react_1.default.createElement("div", null,
            react_1.default.createElement(antd_1.Form, { ref: ref, size: "small", style: { padding: '6px 12px' }, form: form, labelCol: { xs: 9 }, wrapperCol: { xs: 15 }, labelAlign: "left" },
                ...
                react_1.default.createElement(antd_1.Form.Item, { label: "NST", labelCol: { xs: 4 }, wrapperCol: { xs: 18 }, style: { marginBottom: 0 }, name: 'NST' },
                ...
                react_1.default.createElement(antd_1.Form.Item, { label: "CST/OCT", style: { marginBottom: 0 }, labelCol: { xs: 4 }, wrapperCol: { xs: 18 }, name: 'CST_OCT' },
                    react_1.default.createElement(antd_1.Radio.Group, null,
