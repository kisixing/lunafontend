...
function Opts(_a) {
    ...
    return (react_1.default.createElement(antd_1.Select, __assign({ style: { width: 140 } }, o), m.map(function (_a) {
...
function getDeformedOptions(timeChecked) {
    ...
    return {
        S: function (props) {
            return (react_1.default.createElement(antd_1.Select, __assign({ style: { width: 90 } }, props),
