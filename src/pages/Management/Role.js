...
import { Form, Table, Card, Tree, Radio, Button, Input, Select, Modal } from 'antd';
...
@connect(({ global, menu, loading, roleManagemant }) => ({
  loading: loading.effects['userManagemant/query'],
...
class RoleManagemant extends Component {
  ...
  render () {
    const { value, visible, modalType, selectedUser } = this.state;
        ...
        <div className={styles.main}>
          <div className={styles.left}>
            <Card
              title="角色列表"
              extra={
                <Radio.Group size="small" buttonStyle="solid" value={value} onChange={this.handleSizeChange}>
          ...
          <div className={styles.right}>
            <Card title={value} extra={<Button size="small" type="primary">保存</Button>}>
              <Tree checkable>
